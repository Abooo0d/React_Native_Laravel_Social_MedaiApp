...
const GroupCard = ({ data, setShowGroupContainer }) => {
  ...
  return (
    <View
      className={`min-h-[100px] min-w-full relative gap-3 duration-200 hover:bg-gray-300 dark:hover:bg-gray-700 cursor-pointer bg-gray-800 rounded-[10px] group overflow-hidden `}
      onPress={() => {
        setShowGroupContainer();
        router.push(`/pages/Group/${data.slug}`);
        console.log("ABood");
      }}
    >
      <Image
